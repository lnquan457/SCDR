...
if __name__ == '__main__':
    ...
    for i, method in enumerate(method_list):
        ...
        for dataset in dataset_list:
            ...
            dataset_res = []
            res_dict = {}
            # dataset_dir = r"D:\Projects\流数据\Code\SCDR\results\sPCA\electric_devices"
            for k, item in enumerate(os.listdir(dataset_dir)):
                ...
                # eval_embedding_dir = r"D:\Projects\流数据\Code\SCDR\results\sPCA\electric_devices\20230228_18h52m40s\eval_embeddings"
