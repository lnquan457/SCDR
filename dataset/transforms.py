...
class CDRDataTransform(object):
    ...
    def _neighbor_index_fixed(self, index):
        ...
        # idx = self.neighbor_sample_index[index]
        # while sim_index == 5009:
        #     # print(index, sim_index)
        #     idx = (idx + 1) % 1000
        #     sim_index = self.neighbor_sample_repo[index][idx]
