...
if __name__ == '__main__':
    ...
    situation = "PD"
    dataset_list = ["HAR_2", "mnist_fla", "shuttle", "arem", "basketball"]
    ...
    dim_list = [561, 784, 9, 6, 6]

    start_time = time_stamp_to_date_time_adjoin(time.time())
    excel_save_dir = r"D:\Projects\流数据\Evaluation\消融实验\并行框架\excel_res\{}_{}".format(start_time, situation)
    excel_headers = []
    excel_headers.append("Throughout")
    ...
    for i, method_name in enumerate(method_list):
        ...
        for j, dataset_name in enumerate(dataset_list):
            ...
            for e in range(test_time):
                ...
                cur_res = [1/avg_single_process_time, total_process_time, avg_data_delay_time]
