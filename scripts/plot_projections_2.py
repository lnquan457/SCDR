...
if __name__ == '__main__':
    data_dir = r"D:\Projects\流数据\Evaluation\过程数据\散点图_3\原始数据"
    ...
    for method in method_list:
        ...
        for i, dataset in enumerate(dataset_list):
            ...
            dataset_dir = os.path.join(data_dir, dataset, method)
            ...
            embedding_dir = os.path.join(dataset_dir, "eval_embeddings")
            img_save_dir = os.path.join(dataset_dir, "imgs")
            gray_img_save_dir = os.path.join(dataset_dir, "gray_imgs")
